...
export default defineConfig({
  ...
  // Unterordner; ohne base zeigen alle erzeugten Pfade auf die Wurzel
  // des Kontos und nichts lädt. Über eine Umgebungsvariable, damit für
  // eine eigene Domain nur der Wert wegfällt.
